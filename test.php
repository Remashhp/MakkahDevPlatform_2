...
<body>
  <div class="container">
    <aside class="sidebar">
      ...
      <a href="Home Add Course.html">
        <img src=" imageAdmin/AddCourse.svg" alt="أيقونة" />
        <b> اضافة دورة </b>
      </a>
      <a href="Registration Requests.html">
    ...
    <main class="main-content">
      ...
      <div class="divider-section">
        <div class="divider-title" style="color: rgba(8, 105, 130, 1); font-size:35px ;"></div>
