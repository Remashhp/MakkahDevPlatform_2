  ...
  <div class="container">
    ...
    <main class="main-content">
      ...
      <div class="divider-section">
        <div class="divider-title" style="color: rgba(8, 105, 130, 1); font-size:35px ;">الدورات التدريبية</div>
      ...
      <div id="filtersSection"
        ...
        <!-- زر إضافة دورة -->
        <a href="adminAddCourse.php" style="display: flex; align-items: center; gap: 6px; border: 2px solid rgba(13, 169, 166, 1); color: rgba(74, 73, 73, 1); border-radius: 12px; padding: 6px 16px; text-decoration: none; font-weight: bold; font-size: 16px;  background-color: rgba(231, 244, 243, 1);">
          <i class="fas fa-plus" style="color: rgba(74, 73, 73, 1);"></i>
            ...
            <div class="course-card"
              ...
              <div class="card-body">
                ...
                <div class="card-actions">
                  <button class="btn-delete"><i class="fas fa-trash-alt"></i> حذف</button>
                  <button class="btn-edit" onclick="window.location.href='EditCourse.php?id=<?= $id ?>'"><i class="fas fa-edit"></i> تعديل</button>
                  <button class="btn-trainees" onclick="window.location.href='Trainee.php?course_id=<?= $c['id'] ?>'"><i class="far fa-user"></i> المتدربين</button>
