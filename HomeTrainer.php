            ...
            <div class="course-card"
              ...
              <div class="card-body">
                ...
                <div class="card-actions">
                  ...
                  <button class="btn-edit"><i class="fas fa-edit" onclick="window.location.href='EditCourse.php?id=<?= $c['id'] ?>'"></i> تعديل</button>
                  <button class="btn-trainees"><i class="far fa-user"></i> المتدربين</button>
                </div>
              </div>
            </div>
          <?php endwhile; ?>
