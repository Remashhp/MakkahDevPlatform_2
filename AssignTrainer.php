...
<body>
            ...
            <div class="course-card"
              ...
              <div class="card-body">
                ...
                <div class="card-actions">
                  <button class="btn-trainees" data-id="<?= $id ?>">تعيين مدرب</button>
                </div>
              </div>
            </div>
          <?php endwhile; ?>
  ...
  <script>
    ...
    document.querySelectorAll('.btn-trainees').forEach(btn => {
      btn.addEventListener('click', function() {
        const courseId = this.getAttribute('data-id');
        window.location.href = 'TrainerToCourse.php?course_id=' + courseId;
      });
    });
  </script>
