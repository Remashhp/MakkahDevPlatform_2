...
.profile-btn:hover {
  ...
  transform: scale(1.05);
    ...
    h2.section-title {
      color: #17A8A5;
      border-bottom: 4px solid #17A8A5;
    ...
    .icon-circle {
      width: 100px;
      height: 100px;
      background: linear-gradient(to right, #0DA9A6, #054342);
      border-radius: 50%;
      display: flex;
      align-items: center;
...
<?php endif; ?>
  ...
  <main class="container-fluid px-5 my-5">
    <h2 class="section-title">رؤيتنا.. رسالتنا.. قيمنا</h2>

    <img src="https://c.animaapp.com/AVKvvaow/img/rectangle-3468098.png" alt="Main visual" class="img-fluid my-4">

    <div class="row text-center my-5">
      <div class="col-md-4">
        <div class="icon-circle">
          <img src="https://c.animaapp.com/AVKvvaow/img/eye.svg" alt="Vision">
        </div>
        <h3 class="text-teal">رؤيتنا</h3>
        <h4>الكفاءة</h4>
        <p>رأس مال بشري عالي الأداء في القطاع الحكومي.</p>
      </div>
      <div class="col-md-4">
        <div class="icon-circle">
          <img src="https://c.animaapp.com/AVKvvaow/img/--------.svg" alt="Mission">
        </div>
        <h3 class="text-teal">رسالتنا</h3>
        <h4>النمو المهني</h4>
        <p>التحول إلى ممارسة إدارة الموارد البشرية في القطاع الحكومي من خلال سياسات وإجراءات واضحة وبيئة عمل متميزة تحاكي أفضل الممارسات والتقنيات الحديثة في مجال الموارد البشرية.</p>
      </div>
      <div class="col-md-4">
        <div class="icon-circle">
          <img src="https://c.animaapp.com/AVKvvaow/img/award.svg" alt="Values">
        </div>
        <h3 class="text-teal">قيمنا</h3>
        <h4>التطوير</h4>
        <p>رفع جودة أداء الموظف الحكومي وإنتاجيته وتطوير بيئة عمله من خلال وضع سياسات وإجراءات واضحة لتطبيق مفهوم الموارد البشرية.</p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-11 goals-list">
        <p>رفع مستوى أداء المتدربين من شاغلي الوظائف الإدارية.</p>
        <p>تطوير معارف وقدرات العاملين من شاغلي الوظائف الإدارية.</p>
        <p>تعزيز خبرات وتطوير مهارات العاملين.</p>
        <p>تعريف العاملين بالمشكلات التي تواجههم في العمل وطرق علاجها.</p>
        <p>معالجة أوجه القصور في الأداء لدى العاملين.</p>
        <p>تحقيق النمو المهني المستمر للعاملين في الميدان للقيام بمهامهم بكفاءة.</p>
...
function openUpdateWorkplaceModal(event) {
  ...
  <footer>
    <img src="images/2030Vison_Logo.png" alt="رؤية 2030" style="width: 100px;">
    <div class="my-2">
      <a href="#">تواصل معنا</a> | 
      <a href="#">سياسة الخصوصية</a> | 
      <a href="#">الشروط والأحكام</a>
    </div>
    <small>&copy; 2025 جميع الحقوق محفوظة لإدارة تعليم مكة - قسم الموارد البشرية - وحدة التخطيط والتطوير</small>
  </footer>
